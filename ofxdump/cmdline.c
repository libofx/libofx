...
cmdline_parser_print_help (void)
{
  ...
  printf("  -f, --import-format=STRING  Force the file format of the file(s) specified  \n                                (default=`AUTODETECT')\n");
  printf("      --list-import-formats   List available import file formats \n                                'import-format' command\n");
  printf("      --msg_parser            Output file parsing messages  (default=off)\n");
  printf("      --msg_debug             Output messages meant for debuging  (default=\n                                off)\n");
  printf("      --msg_warning           Output warning messages about abnormal \n                                conditions and unknown constructs  (default=\n                                on)\n");
  printf("      --msg_error             Output error messages  (default=on)\n");
  printf("      --msg_info              Output informational messages about the progress \n                                of the library  (default=on)\n");
      ...
      switch (c)
        ...
        case 'f':	/* Force the file format of the file(s) specified.  */
          ...
          if (args_info->import_format_arg)
            free (args_info->import_format_arg); /* free default string */
